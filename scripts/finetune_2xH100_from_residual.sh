...
args=(
    ...
    --use_local_model 
    --lang_model_pretrained jwnt4/blip3-phi3-pissa-4iter  # residual model repo or path
    --lang_model_adapter jwnt4/blip3-mr-v1-lang_model-pissa-r16a16-rslora # pissa adapter to load
    --lora_r 16
    --lora_dropout 0.025
